...
urlpatterns += [
    path('docs/',
         include_docs_urls(title=API_TITLE, description=API_DESCRIPTION, permission_classes=[permissions.IsAuthenticatedOrReadOnly])),
...
urlpatterns += [
    ...
    # path('favicon.ico', RedirectView.as_view(url='{}favicon_{}.ico'.format(settings.STATIC_URL, settings.CLOUD_COMPANY_ALIAS), permanent=True))
]
